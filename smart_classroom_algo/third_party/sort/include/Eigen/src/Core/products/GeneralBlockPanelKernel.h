...
/** \returns the currently set level 1 cpu cache size (in bytes) used to solvePnP the ideal blocking size parameters.
  * \sa setCpuCacheSize */
...
/** \returns the currently set level 2 cpu cache size (in bytes) used to solvePnP the ideal blocking size parameters.
  * \sa setCpuCacheSize */
...
/** \returns the currently set level 3 cpu cache size (in bytes) used to solvePnP the ideal blocking size paramete\
rs.                                                                                                                
* \sa setCpuCacheSize */
