  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'sel_search',value:'classId',text:'关联考场',dictTable:'smc_class', dictText:'class_name', dictCode:'id'})
        fieldList.push({type:'sel_search',value:'videoSrcId',text:'考场监控',dictTable:'smc_video_src', dictText:'video_name', dictCode:'id'})
