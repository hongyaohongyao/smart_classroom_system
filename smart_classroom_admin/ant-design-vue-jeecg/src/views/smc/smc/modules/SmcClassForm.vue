  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24" >
            <a-form-model-item label="考场名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="className">
              <a-input v-model="model.className" placeholder="请输入考场名称" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
    ...
    <a-tabs v-model="activeKey" @change="handleChangeTabs">
      <a-tab-pane tab="参考考生" :key="refKeys[0]" :forceRender="true">
        <j-editable-table
          :ref="refKeys[0]"
