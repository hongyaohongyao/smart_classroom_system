  ...
  <a-card :bordered="false">
    <a-row>
      ...
      <a-col :span="18">
        <a-row>
          <a-col :span="6">
            <a-button @click="stopTask" type="danger" :disabled="disableStopTaskBtn">
              停止签到
            </a-button>
          </a-col>
        </a-row>
...
export default {
  ...
  data() {
    return {
      taskId: this.$route.params.task_id || "1503001796995784705",
      showSnapshot: false,
      taskInfo: {},
      isLive: true,
      isCatchFrame: false,
  ...
  methods: {
    ...
    stopTask() {
      ...
      deleteAction(that.url.stop, {id: that.taskId}).then(function (resp) {
        if (resp.success) {
